...
<div class="card border-0 shadow-sm" style="border-radius: 16px; overflow: hidden;">
    ...
    <div class="card-body p-0">
        ...
        <div class="px-3 py-3" style="background: #f8fafc; border-bottom: 1px solid #e2e8f0;">
            <form method="GET" action="{{ route('jenis_penggunaan.index') }}">
                <div class="row g-3 align-items-center">
                    ...
                    <!-- Filter Dropdown -->
                    <div class="col-md-3">
                        <select name="nama_penggunaan" class="form-select" style="border-radius: 10px;">
                            <option value="">Semua Nama Penggunaan</option>
